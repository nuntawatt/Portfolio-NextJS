...
export function ContactCTA() {
  return (
    <section id="contact" className="scroll-mt-24 py-16 md:py-24 lg:py-28 relative overflow-hidden bg-gray-100 dark:bg-white/[0.01] transition-colors duration-300">
