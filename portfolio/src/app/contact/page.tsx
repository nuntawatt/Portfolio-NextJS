...
export default function ContactPage() {
  ...
  return (
    <main className="min-h-screen w-full relative flex flex-col items-center justify-center bg-gradient-to-br from-white to-orange-50 dark:from-black dark:to-neutral-950 p-4 sm:p-6 md:p-8">
      {/* Global dot-grid overlay */}
      <div className="blocks-grid-overlay opacity-30 mix-blend-overlay" />

      {/* Floating Spotlight Header Nav */}
      <header className="fixed top-0 left-0 right-0 z-50 flex items-center justify-between px-5 py-4 blocks-glass-nav select-none">
        <a 
          href="/" 
          className="flex items-center gap-2 text-sm font-bold text-gray-700 dark:text-gray-200 hover:text-orange-500 transition-colors"
        >
          <ArrowLeft className="w-4 h-4" /> Back to Home
        </a>
        <div className="flex items-center gap-3">
          <span className="font-heading text-lg font-bold text-black dark:text-white">
            Morgorn®
          </span>
          <span className="text-xl text-black dark:text-white">✳︎</span>
        </div>
      </header>

      {/* Contact window mockup container */}
      <div
        className="relative w-full max-w-xl blocks-glass-card rounded-[24px] p-6 sm:p-8 overflow-hidden transition-all duration-300 mt-16"
          ...
          <form onSubmit={handleSubmit} className="space-y-4 text-left">
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
              <div className="flex flex-col gap-1.5">
                <label className="text-xs font-bold text-gray-500 uppercase tracking-wider select-none">
                  Your Name
                </label>
                <input
                  type="text"
                  ...
                  className="w-full px-4 py-2.5 rounded-xl border border-black/10 dark:border-white/10 bg-white/50 dark:bg-neutral-900 text-gray-900 dark:text-white focus:outline-none focus:border-orange-500/50 transition-colors text-sm font-medium"
                />
              </div>
              <div className="flex flex-col gap-1.5">
                <label className="text-xs font-bold text-gray-500 uppercase tracking-wider select-none">
            ...
            <div className="flex flex-col gap-1.5">
              ...
              <textarea
                ...
                className="w-full px-4 py-2.5 rounded-xl border border-black/10 dark:border-white/10 bg-white/50 dark:bg-neutral-900 text-gray-900 dark:text-white focus:outline-none focus:border-orange-500/50 transition-colors text-sm font-medium resize-none"
              />
            </div>
