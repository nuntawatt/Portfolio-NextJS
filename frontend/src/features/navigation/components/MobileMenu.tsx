  ...
  return (
    <>
      ...
      <dialog
        ...
        open={isOpen}
        className={cn(
          "fixed top-0 right-0 left-auto h-full w-[280px] bg-card border-y-0 border-r-0 border-l border-border shadow-2xl z-50 lg:hidden transform flex flex-col transition-transform duration-500 ease-[cubic-bezier(0.22,1,0.36,1)] m-0 p-0 max-w-none max-h-none",
